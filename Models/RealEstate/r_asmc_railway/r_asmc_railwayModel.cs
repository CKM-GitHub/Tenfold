...
namespace Models.RealEstate.r_asmc_railway
{
    ...
    public class r_asmc_railway_Pref : r_asmc_address_Pref
    {
    }

    public class r_asmc_railway_LineCompany : r_asmc_address_CityGroup
    {
    }

    public class r_asmc_railway_Line : r_asmc_address_City
    {
    }
