IF EXISTS (select * from sys.objects where name = 'pr_a_index_Select_Cities_by_ZipCode')
BEGIN
    DROP PROCEDURE [pr_a_index_Select_Cities_by_ZipCode]
END
GO

CREATE PROCEDURE [dbo].[pr_a_index_Select_Cities_by_ZipCode]
(
    @ZipCode1 varchar(3)
    ,@ZipCode2 varchar(4)
)
