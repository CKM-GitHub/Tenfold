IF EXISTS (select * from sys.objects where name = 'pr_a_mypage_uinfo_Insert_D_Certification')
BEGIN
    DROP PROCEDURE [pr_a_mypage_uinfo_Insert_D_Certification]
END
GO

CREATE PROCEDURE [dbo].[pr_a_mypage_uinfo_Insert_D_Certification]
(
