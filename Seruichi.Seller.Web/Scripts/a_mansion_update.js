...
$(function () {
    ...
    _url.getlineStationDistanceBySellerMansionID = common.appPath + '/a_mansion_update/GetlineStationDistanceBySellerMansionID';
        ...
        function (result) {
            if (result && result.isOK) {
                ...
                if (length > 0) {
                    ...
                    $('#PrefCD, #CityCD, #TownCD, #MansionName').hideError();
                    common.hideLoading();
                }
            }
        },
